...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('estágios', function (Blueprint $table) {           
            ...
            $table->foreignId('solicitacao_vagas_id')->references('id')->on('Solicitacao_Vagas')->onDelete('cascade')->nullable();
            $table->foreignId('estado_estagio_id')->references('id')->on('Estado_Estagio')->onDelete('cascade')->nullable();
            $table->timestamps();
        });
    }
